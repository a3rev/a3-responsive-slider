    ...
    <div id="a3-rslider-container-<?php echo $unique_id; ?>" class="a3-rslider-container a3-rslider-<?php echo $slider_template; ?>" slider-id="<?php echo $unique_id; ?>" max-height="<?php echo $max_height; ?>" width-of-max-height="<?php echo $width_of_max_height; ?>" is-responsive="<?php echo $is_slider_responsive; ?>" is-tall-dynamic="<?php echo $is_slider_tall_dynamic; ?>" style="<?php if ( '' !== trim( $z_index ) ) echo "z-index:$z_index !important;"; ?> <?php echo $rslider_custom_style; ?>" >
        ...
        >
            ...
            <div class="a3-cycle-pauseplay">
                <span class="cycle-pause-control"><span class="fa fa-pause cycle-pause" data-cycle-cmd="pause" data-cycle-context="#a3-cycle-slideshow-<?php echo $unique_id; ?>" onclick="return false;" style=" <?php if ( $is_auto_start == 0 ) { echo 'display:none'; } ?>"></span></span>
                <span class="cycle-play-control"><span class="fa fa-play cycle-play" data-cycle-cmd="resume" data-cycle-context="#a3-cycle-slideshow-<?php echo $unique_id; ?>" onclick="return false;" style=" <?php if ( $is_auto_start != 0 ) { echo 'display:none'; } ?>"></span></span>
            </div>
