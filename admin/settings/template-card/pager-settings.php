...
class A3_Responsive_Slider_Template_Card_Pager_Settings extends A3_Responsive_Slider_Admin_UI
{
	 ...
	 */
	public $option_name = 'a3_rslider_template_card_pager_settings';
	
	/**
	 * @var string
	 * You must change to correct form key that you are working
	 */
	public $form_key = 'a3_rslider_template_card_pager_settings';
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'callback_function'	=> 'a3_responsive_sider_template_card_pager_settings_form',
		);
 ...
 */
function a3_responsive_sider_template_card_pager_settings_form() {
	global $a3_responsive_sider_template_card_pager_settings;
