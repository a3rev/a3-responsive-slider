...
<?php
/*-----------------------------------------------------------------------------------
Slider Mobile Template Caption Settings
...
class A3_Responsive_Slider_Template_Mobile_Caption_Settings extends A3_Responsive_Slider_Admin_UI
{
	
	/**
	 * @var string
	 */
	private $parent_tab = 'caption-mobile';
	 ...
	 */
	public $option_name = 'a3_rslider_template_mobile_caption_settings';
	
	/**
	 * @var string
	 * You must change to correct form key that you are working
	 */
	public $form_key = 'a3_rslider_template_mobile_caption_settings';
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'callback_function'	=> 'a3_responsive_sider_template_mobile_caption_settings_form',
		);
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(  
				...
				'id' 		=> 'caption_font',
				'type' 		=> 'typography',
				'default'	=> array( 'size' => '12px', 'line_height' => '1.4em', 'face' => 'Arial, sans-serif', 'style' => 'normal', 'color' => '#666666' )
			),
...
global $a3_responsive_sider_template_mobile_caption_settings;
$a3_responsive_sider_template_mobile_caption_settings = new A3_Responsive_Slider_Template_Mobile_Caption_Settings();

/** 
 * a3_responsive_sider_template_mobile_caption_settings_form()
 * Define the callback function to show subtab content
 */
function a3_responsive_sider_template_mobile_caption_settings_form() {
	global $a3_responsive_sider_template_mobile_caption_settings;
	$a3_responsive_sider_template_mobile_caption_settings->settings_form();
}
