...
<?php
/*-----------------------------------------------------------------------------------
Slider Mobile Template Pager Settings
...
class A3_Responsive_Slider_Template_Mobile_Pager_Settings extends A3_Responsive_Slider_Admin_UI
{
	 ...
	 */
	public $option_name = 'a3_rslider_template_mobile_pager_settings';
	
	/**
	 * @var string
	 * You must change to correct form key that you are working
	 */
	public $form_key = 'a3_rslider_template_mobile_pager_settings';
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'callback_function'	=> 'a3_responsive_sider_template_mobile_pager_settings_form',
		);
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(  
				'name' 		=> __( 'Pager Container Padding', 'a3-responsive-slider' ),
			...
			array(  
				'name' 		=> __( 'Pager Font', 'a3-responsive-slider' ),
				'id' 		=> 'pager_font',
				'type' 		=> 'typography',
				'default'	=> array( 'size' => '11px', 'line_height' => '1.4em', 'face' => 'Arial, sans-serif', 'style' => 'normal', 'color' => '#FFFFFF' )
			),
...
$a3_responsive_sider_template_mobile_pager_settings = new A3_Responsive_Slider_Template_Mobile_Pager_Settings();

/** 
 * a3_responsive_sider_template_mobile_pager_settings_form()
 * Define the callback function to show subtab content
 */
function a3_responsive_sider_template_mobile_pager_settings_form() {
	global $a3_responsive_sider_template_mobile_pager_settings;
