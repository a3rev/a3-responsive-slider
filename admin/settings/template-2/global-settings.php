...
<?php
/*-----------------------------------------------------------------------------------
Slider Template 2 Global Settings
...
class A3_Responsive_Slider_Template_2_Global_Settings extends A3_Responsive_Slider_Admin_UI
{
	 ...
	 */
	public $option_name = 'a3_rslider_template2_global_settings';
	
	/**
	 * @var string
	 * You must change to correct form key that you are working
	 */
	public $form_key = 'a3_rslider_template2_global_settings';
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'callback_function'	=> 'a3_responsive_sider_template_2_global_settings_form',
		);
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(  
				...
				'id' 		=> 'a3_rslider_template_2',
				'type' 		=> 'text',
				'default'	=> __( 'Template 2', 'a3-responsive-slider' ),
				'separate_option'	=> true,
				'custom_attributes'	=> array( 'maxlength' => 17 )
			),
			array(  
				'name' 		=> __( 'Activate Template', 'a3-responsive-slider' ),
				'id' 		=> 'is_activated',
				'class'		=> 'is_activated',
				'type' 		=> 'onoff_checkbox',
				'default'	=> 1,
...
$(document).ready(function() {
	...
	if ( $("input.is_activated:checked").val() != '1') {
		$(".is_activated_on").css( {'visibility': 'hidden', 'height' : '0px', 'overflow' : 'hidden', 'margin-bottom' : '0px' } );
	}

	$(document).on( "a3rev-ui-onoff_checkbox-switch", '.is_activated', function( event, value, status ) {
		$(".is_activated_on").attr('style','display:none;');
		if ( status == 'true' ) {
...
$a3_responsive_sider_template_2_global_settings = new A3_Responsive_Slider_Template_2_Global_Settings();

/** 
 * a3_responsive_sider_template_2_global_settings_form()
 * Define the callback function to show subtab content
 */
function a3_responsive_sider_template_2_global_settings_form() {
	global $a3_responsive_sider_template_2_global_settings;
	$a3_responsive_sider_template_2_global_settings->settings_form();
}
