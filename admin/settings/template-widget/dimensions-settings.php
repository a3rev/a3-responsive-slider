...
<?php
/*-----------------------------------------------------------------------------------
Slider Widget Template Dimensions Settings
...
class A3_Responsive_Slider_Template_Widget_Dimensions_Settings extends A3_Responsive_Slider_Admin_UI
{
	 ...
	 */
	public $option_name = 'a3_rslider_template_widget_dimensions_settings';
	
	/**
	 * @var string
	 * You must change to correct form key that you are working
	 */
	public $form_key = 'a3_rslider_template_widget_dimensions_settings';
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'callback_function'	=> 'a3_responsive_sider_template_widget_dimensions_settings_form',
		);
...
global $a3_responsive_sider_template_widget_dimensions_settings;
$a3_responsive_sider_template_widget_dimensions_settings = new A3_Responsive_Slider_Template_Widget_Dimensions_Settings();

/** 
 * a3_responsive_sider_template_widget_dimensions_settings_form()
 * Define the callback function to show subtab content
 */
function a3_responsive_sider_template_widget_dimensions_settings_form() {
	global $a3_responsive_sider_template_widget_dimensions_settings;
	$a3_responsive_sider_template_widget_dimensions_settings->settings_form();
}
