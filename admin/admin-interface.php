...
class A3_Responsive_Slider_Admin_Interface extends A3_Responsive_Slider_Admin_UI
{
			...
			switch ( trim( $_REQUEST['type'] ) ) {
				...
				case 'check_new_version':
					...
					if ( '' == trim( $version_message ) ) {
						$version_message = __( 'Great! You have the latest version installed.', 'a3-responsive-slider' );
						$has_new_version = 0;
					} else {
	...
	public function get_success_message( $message = '' ) {
		if ( trim( $message ) == '' ) $message = __( 'Settings successfully saved.' , 'a3-responsive-slider' ); 
	...
	public function get_error_message( $message = '' ) {
		if ( trim( $message ) == '' ) $message = __( 'Error: Settings can not save.' , 'a3-responsive-slider' ); 
	...
	public function get_reset_message( $message = '' ) {
		if ( trim( $message ) == '' ) $message = __( 'Settings successfully reseted.' , 'a3-responsive-slider' ); 
		return '<div class="updated" id=""><p>' . $message . '</p></div>';
	}
	...
	public function get_font_weights() {
		$font_weights = array (
			'300'				=> __( 'Thin', 'a3-responsive-slider' ),
			'300 italic'		=> __( 'Thin/Italic', 'a3-responsive-slider' ),
			'normal'			=> __( 'Normal', 'a3-responsive-slider' ),
			'italic'			=> __( 'Italic', 'a3-responsive-slider' ),
			'bold'				=> __( 'Bold', 'a3-responsive-slider' ),
			'bold italic'		=> __( 'Bold/Italic', 'a3-responsive-slider' ),
		);
	...
	public function get_border_styles() {
		$border_styles = array (
			'solid'				=> __( 'Solid', 'a3-responsive-slider' ),
			'double'			=> __( 'Double', 'a3-responsive-slider' ),
			'dashed'			=> __( 'Dashed', 'a3-responsive-slider' ),
			'dotted'			=> __( 'Dotted', 'a3-responsive-slider' ),
			'groove'			=> __( 'Groove', 'a3-responsive-slider' ),
			'ridge'				=> __( 'Ridge', 'a3-responsive-slider' ),
			'inset'				=> __( 'Inset', 'a3-responsive-slider' ),
			'outset'			=> __( 'Outset', 'a3-responsive-slider' ),
		);
	...
	public function admin_forms( $options, $form_key, $option_name = '', $form_messages = array() ) {
		...
		foreach ( $options as $value ) {
			...
			switch( $value['type'] ) {
				...
				case 'google_api_key':
					...
					if ( ! isset( $value['checked_label'] ) ) $value['checked_label'] = __( 'ON', 'a3-responsive-slider' );
					if ( ! isset( $value['unchecked_label'] ) ) $value['unchecked_label'] = __( 'OFF', 'a3-responsive-slider' );

					?><tr valign="top">
						<th scope="row" class="titledesc">
                        	<?php echo $tip; ?>
							<label for="<?php echo esc_attr( $this->google_api_key_option ); ?>"><?php echo __( 'Google Fonts API', 'a3-responsive-slider' ); ?></label>
						</th>
						<td class="forminp forminp-onoff_checkbox forminp-<?php echo esc_attr( sanitize_title( $value['type'] ) ); ?>">
							<input
								...
								/> <span class="description" style="margin-left:5px;"><?php echo __( 'ON to connect to Google Fonts API and have auto font updates direct from Google.', 'a3-responsive-slider' ); ?></span>

							<div>&nbsp;</div>
							<div class="a3rev-ui-google-api-key-container" style="<?php if( 1 != $google_api_key_enable ) { echo 'display: none;'; } ?>">
								<div class="a3rev-ui-google-api-key-description"><?php echo sprintf( __( "Enter your existing Google Fonts API Key below. Don't have a key? Visit <a href='%s' target='_blank'>Google Developer API</a> to create a key", 'a3-responsive-slider' ), 'https://developers.google.com/fonts/docs/developer_api#APIKey' ); ?></div>
								<div class="a3rev-ui-google-api-key-inside 
									<?php
									if ( $a3_responsive_slider_fonts_face->is_valid_google_api_key() ) {
									...
									<input
		                                ...
		                                placeholder="<?php echo __( 'Google Fonts API Key', 'a3-responsive-slider' ); ?>"
										<?php echo implode( ' ', $custom_attributes ); ?>
										/>
									<p class="a3rev-ui-google-valid-key-message"><?php echo __( 'Your Google API Key is valid and automatic font updates are enabled.', 'a3-responsive-slider' ); ?></p>
									<p class="a3rev-ui-google-unvalid-key-message"><?php echo __( 'Please enter a valid Google API Key.', 'a3-responsive-slider' ); ?></p>
								</div>
							</div>
						</td>
					</tr><?php
				...
				case 'google_map_api_key':
					...
					?><tr valign="top">
						<th scope="row" class="titledesc">
                        	<?php echo $tip; ?>
							<label for="<?php echo esc_attr( $this->google_map_api_key_option ); ?>"><?php echo __( 'Google Maps API', 'a3-responsive-slider' ); ?></label>
						</th>
						<td class="forminp forminp-onoff_checkbox forminp-<?php echo esc_attr( sanitize_title( $value['type'] ) ); ?>">
							<input
								...
								/> <span class="description" style="margin-left:5px;"><?php echo __( 'Switch ON to connect to Google Maps API', 'a3-responsive-slider' ); ?></span>

							<div>&nbsp;</div>
							<div class="a3rev-ui-google-api-key-container" style="<?php if( 1 != $google_map_api_key_enable ) { echo 'display: none;'; } ?>">
								<div class="a3rev-ui-google-api-key-description"><?php echo sprintf( __( "Enter your existing Google Map API Key below. Don't have a key? Visit <a href='%s' target='_blank'>Google Maps API</a> to create a key", 'a3-responsive-slider' ), 'https://developers.google.com/maps/documentation/javascript/get-api-key' ); ?></div>
								<div class="a3rev-ui-google-api-key-inside 
									<?php
									...
									<input
										...
										class="a3rev-ui-text a3rev-ui-<?php echo esc_attr( sanitize_title( $value['type'] ) ); ?> <?php echo esc_attr( $value['class'] ); ?>"
		                                placeholder="<?php echo __( 'Google Map API Key', 'a3-responsive-slider' ); ?>"
										<?php echo implode( ' ', $custom_attributes ); ?>
										/>
									<p class="a3rev-ui-google-valid-key-message"><?php echo __( 'Your Google API Key is valid and automatic font updates are enabled.', 'a3-responsive-slider' ); ?></p>
									<p class="a3rev-ui-google-unvalid-key-message"><?php echo __( 'Please enter a valid Google API Key.', 'a3-responsive-slider' ); ?></p>
				...
				case 'manual_check_version':
					...
					if ( is_multisite() ) {
						$version_message = __( 'Sorry, this feature just for Network Admin.', 'a3-responsive-slider' );
					} else {
						global $a3_dashboard_plugin_requirement;

						if ( ! $a3_dashboard_plugin_requirement->is_installed() ) {
							$version_message = sprintf( __( 'You need to install and activate the <a title="" href="%s" target="_parent">a3rev Dashboard plugin</a> for manage version and get auto upgrade to latest version.', 'a3-responsive-slider' ), $a3_dashboard_plugin_requirement->install_url() );
						} elseif ( ! $a3_dashboard_plugin_requirement->is_activated() ) {
							$version_message = sprintf( __( 'You need to activate the <a title="" href="%s" target="_parent">a3rev Dashboard plugin</a> for manage version and get auto upgrade to latest version.', 'a3-responsive-slider' ), $a3_dashboard_plugin_requirement->activate_url() );
						} elseif ( function_exists( 'is_a3_club_membership' ) && ! is_a3_club_membership() ) {
							$version_message = sprintf( __( 'You need to go to <a title="" href="%s">a3 Dashboard Main page</a> for login before check for Update. Use your account creds on <a href="https://a3rev.com" target="_parent">a3rev.com</a> to login.', 'a3-responsive-slider' ), self_admin_url( 'admin.php?page=a3rev-dashboard' ) );
						} else {
							$check_version_class = 'a3rev-ui-latest-version-message';
							$version_message = sprintf( __( 'Go to <a href="%s">a3 Dashboard Main page</a> and hit on <strong>CHECK NOW</strong> button to manual check for Update.', 'a3-responsive-slider' ), self_admin_url( 'admin.php?page=a3rev-dashboard' ) );
						}
					}
				...
				case 'onoff_toggle_box' :
					...
					?><tr valign="top">
						<th scope="row" class="titledesc">
                        	<?php echo $tip; ?>
							<label for="<?php echo esc_attr( $this->toggle_box_open_option ); ?>"><?php echo __( 'Open Box Display', 'a3-responsive-slider' ); ?></label>
						</th>
						<td class="forminp forminp-onoff_checkbox forminp-<?php echo esc_attr( sanitize_title( $value['type'] ) ); ?>">
							<input
								...
								<?php echo implode( ' ', $custom_attributes ); ?>
								/> <span class="description" style="margin-left:5px;"><?php echo __( 'ON and each admin panel setting box OPEN | CLOSED position are saved each time changes are SAVED.', 'a3-responsive-slider' ); ?></span>
                        </td>
					</tr><?php
				break;
							...
							<fieldset>
								...
								if ( is_array( $value['onoff_options'] ) && count( $value['onoff_options'] ) > 0 ) {
									foreach ( $value['onoff_options'] as $i_option ) {
										if ( ! isset( $i_option['checked_label'] ) ) $i_option['checked_label'] = __( 'ON', 'a3-responsive-slider' );
										if ( ! isset( $i_option['unchecked_label'] ) ) $i_option['unchecked_label'] = __( 'OFF', 'a3-responsive-slider' );
				...
				case 'image_size' :
					...
					?><tr valign="top">
						...
						<td class="forminp forminp-<?php echo esc_attr( sanitize_title( $value['type'] ) ); ?>">
							...
							<label><?php _e( 'Width', 'a3-responsive-slider' ); ?> <input name="<?php echo $name_attribute; ?>[width]" id="<?php echo $id_attribute; ?>-width" type="text" class="a3rev-ui-<?php echo sanitize_title( $value['type'] ) ?>-width" value="<?php echo $width; ?>" /></label>
	
							<label><?php _e( 'Height', 'a3-responsive-slider' ); ?> <input name="<?php echo $name_attribute; ?>[height]" id="<?php echo $id_attribute; ?>-height" type="text" class="a3rev-ui-<?php echo sanitize_title( $value['type'] ) ?>-height" value="<?php echo $height; ?>" /></label>
	
							<label><?php _e( 'Hard Crop', 'a3-responsive-slider' ); ?> <input name="<?php echo $name_attribute; ?>[crop]" id="<?php echo $id_attribute; ?>-crop" type="checkbox" class="a3rev-ui-<?php echo sanitize_title( $value['type'] ) ?>-crop" <?php echo $crop; ?> /></label>
						...
						<td class="forminp">
                           ...
                           <!-- Font Face -->
							<select
								...
								>
								<optgroup label="<?php _e( '-- Default Fonts --', 'a3-responsive-slider' ); ?>">
                                <?php
									foreach ( $a3_responsive_slider_fonts_face->get_default_fonts() as $val => $text ) {
										?>
                                ...
                                <optgroup label="<?php _e( '-- Google Fonts --', 'a3-responsive-slider' ); ?>">
                                <?php
									foreach ( $a3_responsive_slider_fonts_face->get_google_fonts() as $font ) {
										?>
                           ...
                           <!-- Preview Button -->
                           <div class="a3rev-ui-typography-preview"><a href="#" class="a3rev-ui-typography-preview-button button submit-button" title="<?php _e( 'Preview your customized typography settings', 'a3-responsive-slider' ); ?>"><span>&nbsp;</span></a></div>
				...
				case 'border':
					...
					?><tr valign="top">
						...
						<td class="forminp forminp-border_corner">
                           ...
                           <!-- Preview Button -->
                           <div class="a3rev-ui-settings-preview"><a href="#" class="a3rev-ui-border-preview-button a3rev-ui-settings-preview-button button submit-button" title="<?php _e( 'Preview your customized border settings', 'a3-responsive-slider' ); ?>"><span>&nbsp;</span></a></div>
                           <span class="description" style="margin-left:5px;"><?php echo __( '0px = No Border', 'a3-responsive-slider' ); ?></span>
                           ...
                           <!-- Border Corner : Rounded or Square -->
								<input
                                    ...
                                    checked_label="<?php _e( 'Rounded', 'a3-responsive-slider' ); ?>"
                                    unchecked_label="<?php _e( 'Square', 'a3-responsive-slider' ); ?>"
                                    type="checkbox"
                                    value="rounded"
							...
							<!-- Border Rounded Value -->
								<div class="a3rev-ui-border-corner-value-container">
                                	<div class="a3rev-ui-border_corner-top_left">
                                        <span class="a3rev-ui-border_corner-span"><?php _e( 'Top Left Corner', 'a3-responsive-slider' ); ?></span>
                                    ...
                                    <div class="a3rev-ui-border_corner-top_right">
                                        <span class="a3rev-ui-border_corner-span"><?php _e( 'Top Right Corner', 'a3-responsive-slider' ); ?></span> 
                                        <div class="a3rev-ui-slide-container">
                                            <div class="a3rev-ui-slide-container-start">
                                                <div class="a3rev-ui-slide-container-end">
                                    ...
                                    <div class="a3rev-ui-border_corner-bottom_right">
                                        <span class="a3rev-ui-border_corner-span"><?php _e( 'Bottom Right Corner', 'a3-responsive-slider' ); ?></span> 
                                        <div class="a3rev-ui-slide-container">
                                            <div class="a3rev-ui-slide-container-start">
                                                <div class="a3rev-ui-slide-container-end">
                                    ...
                                    <div class="a3rev-ui-border_corner-bottom_left">
                                        <span class="a3rev-ui-border_corner-span"><?php _e( 'Bottom Left Corner', 'a3-responsive-slider' ); ?></span>
                                        <div class="a3rev-ui-slide-container"> 
                                            <div class="a3rev-ui-slide-container-start">
                                                <div class="a3rev-ui-slide-container-end">
				...
				case 'border_styles':
					...
					?><tr valign="top">
						...
						<td class="forminp">
                           ...
                           <!-- Preview Button -->
                           <div class="a3rev-ui-settings-preview"><a href="#" class="a3rev-ui-border-preview-button a3rev-ui-settings-preview-button button submit-button" title="<?php _e( 'Preview your customized border styles settings', 'a3-responsive-slider' ); ?>"><span>&nbsp;</span></a></div>
                           <span class="description" style="margin-left:5px;"><?php echo __( '0px = No Border', 'a3-responsive-slider' ); ?></span>
                           </div>
					...
					?><tr valign="top">
						...
						<td class="forminp forminp-box_shadow">
							...
							<select
                                ...
                                data-placeholder="<?php _e( 'Horizontal Shadow', 'a3-responsive-slider' ); ?>"
								>
								<?php
									for ( $i = -20; $i <= 20; $i++ ) {
										?>
							...
							<select
                                ...
                                data-placeholder="<?php _e( 'Vertical Shadow', 'a3-responsive-slider' ); ?>"
								>
								<?php
									for ( $i = -20; $i <= 20; $i++ ) {
										?>
                           ...
                           <!-- Box Blur Distance -->
							<select
                                ...
                                data-placeholder="<?php _e( 'Blur Distance', 'a3-responsive-slider' ); ?>"
								>
								<?php
									for ( $i = 0; $i <= 20; $i++ ) {
										?>
                           ...
                           <!-- Box Spread -->
							<select
                                ...
                                data-placeholder="<?php _e( 'Spread Size', 'a3-responsive-slider' ); ?>"
								>
								<?php
									for ( $i = 0; $i <= 20; $i++ ) {
										?>
                           ...
                           <!-- Box Shadow Inset -->
                                <input
                                    ...
                                    checked_label="<?php _e( 'INNER', 'a3-responsive-slider' ); ?>"
                                    unchecked_label="<?php _e( 'OUTER', 'a3-responsive-slider' ); ?>"
                                    type="checkbox"
                                    value="inset"
                           ...
                           <input
                            ...
                            <!-- Preview Button -->
                           <div class="a3rev-ui-settings-preview"><a href="#" class="a3rev-ui-box_shadow-preview-button a3rev-ui-settings-preview-button button submit-button" title="<?php _e( 'Preview your customized box shadow settings', 'a3-responsive-slider' ); ?>"><span>&nbsp;</span></a></div>   
                           </div>
                           <div style="clear:both;"></div>
                           </div>
						</td>
				...
				case 'upload':
					...
					?><tr valign="top">
						...
						<td class="forminp forminp-<?php echo esc_attr( sanitize_title( $value['type'] ) ); ?>">
                        	<?php echo $description; ?>
                        	<?php echo $a3_responsive_slider_uploader->upload_input( $name_attribute, $id_attribute, $option_value, $attachment_id, $value['default'], $value['name'], $class, esc_attr( $value['css'] ) , '', $strip_methods );?>
						</td>
					</tr><?php
		...
		<?php do_action( $this->plugin_name . '-' . trim( $form_key ) . '_settings_end' ); ?>
            <p class="submit">
                    <input type="submit" value="<?php _e('Save changes', 'a3-responsive-slider' ); ?>" class="button button-primary" name="bt_save_settings" />
                    <input type="submit" name="bt_reset_settings" class="button" value="<?php _e('Reset Settings', 'a3-responsive-slider' ); ?>"  />
...
$a3_responsive_slider_admin_interface = new A3_Responsive_Slider_Admin_Interface();
