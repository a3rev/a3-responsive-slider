		...
		if ( isset( $_REQUEST['type'] ) ) {
			switch ( trim( $_REQUEST['type'] ) ) {
				...
				case 'check_new_version':
					...
					$new_version = '';
					if ( class_exists( 'A3_Responsive_Slider_Upgrade' ) ) {
						$new_version = A3_Responsive_Slider_Upgrade::get_version_info();
					}
					...
					if ( '' == trim( $version_message ) ) {
						...
						delete_option('a3_rslider_lite_clean_on_deletion');
						if ( is_array( $new_version ) && 'valid' == $new_version['is_valid_key'] ) {
							...
							if ( isset( $current_update_plugins->response ) ) {
								$plugin_name = A3_RESPONSIVE_SLIDER_NAME;
			...
			switch( $value['type'] ) {
				...
				case 'manual_check_version':
					...
					?><tr valign="top">
						<th scope="row" class="titledesc">
                        	<?php echo $tip; ?>
							<label><?php echo __( 'Check New Version', 'a3-responsive-slider' ); ?></label>
						</th>
						<td class="forminp forminp-manual_check_version">
							...
							<input
                                ...
                                type="button"
								value="<?php echo __( 'Check Now', 'a3-responsive-slider' ); ?>"
					...
					?><tr valign="top">
						...
						<td class="forminp forminp-box_shadow">
                            <input
                                    ...
                                    checked_label="<?php _e( 'YES', 'a3-responsive-slider' ); ?>"
                                    unchecked_label="<?php _e( 'NO', 'a3-responsive-slider' ); ?>"
                                    type="checkbox"
                                    value="1"
                                    <?php checked( 1, $enable ); ?>
                                    <?php echo implode( ' ', $custom_attributes ); ?>
