...
function a3_rslider_activated(){
	update_option('a3rev_rslider_version', '1.7.0');
...
add_filter( $a3_responsive_slider_admin_init->plugin_name . '_plugin_extension_boxes', array( 'A3_Responsive_Slider_Hook_Filter', 'plugin_extension_box' ) );
...
add_action( 'wp_enqueue_scripts', array( 'A3_Responsive_Slider_Hook_Filter', 'include_frontend_script' ), 10 );

// Include google fonts into header
add_action( 'wp_enqueue_scripts', array( 'A3_Responsive_Slider_Hook_Filter', 'add_google_fonts'), 9 );
...
function a3_rslider_upgrade_plugin () {
	global $a3_responsive_slider_admin_init, $a3_responsive_slider_less;
