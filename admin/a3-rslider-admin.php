...
add_filter( $a3_responsive_slider_admin_init->plugin_name . '_plugin_extension_boxes', array( '\A3Rev\RSlider\Hook_Filter', 'plugin_extension_box' ) );
//add_filter( $a3_responsive_slider_admin_init->plugin_name . '_plugin_extension', array( '\A3Rev\RSlider\Hook_Filter', 'plugin_extension' ) );
