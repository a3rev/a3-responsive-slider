...
<?php
/*-----------------------------------------------------------------------------------
Slider Template Widget Global Settings Tab
...
class A3_Responsive_Slider_Template_Widget_Global_Settings_Tab extends A3_Responsive_Slider_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'a3_responsive_slider_template_widget_global_settings_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/template-widget/global-settings.php' );
...
$a3_responsive_slider_template_widget_global_settings_tab = new A3_Responsive_Slider_Template_Widget_Global_Settings_Tab();

/** 
 * people_contact_grid_view_tab_manager()
 * Define the callback function to show tab content
 */
function a3_responsive_slider_template_widget_global_settings_tab_manager() {
	global $a3_responsive_slider_template_widget_global_settings_tab;
	$a3_responsive_slider_template_widget_global_settings_tab->tab_manager();
}
