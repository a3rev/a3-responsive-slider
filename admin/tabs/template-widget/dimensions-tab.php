...
<?php
/*-----------------------------------------------------------------------------------
Slider Widget Template Dimensions Tab
...
class A3_Responsive_Slider_Template_Widget_Dimensions_Tab extends A3_Responsive_Slider_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'a3_responsive_slider_template_widget_dimensions_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/template-widget/dimensions-settings.php' );
...
$a3_responsive_slider_template_widget_dimensions_tab = new A3_Responsive_Slider_Template_Widget_Dimensions_Tab();

/** 
 * people_contact_grid_view_tab_manager()
 * Define the callback function to show tab content
 */
function a3_responsive_slider_template_widget_dimensions_tab_manager() {
	global $a3_responsive_slider_template_widget_dimensions_tab;
	$a3_responsive_slider_template_widget_dimensions_tab->tab_manager();
}
