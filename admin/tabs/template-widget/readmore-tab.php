...
<?php
/*-----------------------------------------------------------------------------------
Slider Widget Template Readmore Tab
...
class A3_Responsive_Slider_Template_Widget_ReadMore_Tab extends A3_Responsive_Slider_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			'name'				=> 'readmore-widget',
			'label'				=> __( 'Read More', 'a3-responsive-slider' ),
			'callback_function'	=> 'a3_responsive_slider_template_widget_readmore_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/template-widget/readmore-settings.php' );
...
$a3_responsive_slider_template_widget_readmore_tab = new A3_Responsive_Slider_Template_Widget_ReadMore_Tab();

/** 
 * people_contact_grid_view_tab_manager()
 * Define the callback function to show tab content
 */
function a3_responsive_slider_template_widget_readmore_tab_manager() {
	global $a3_responsive_slider_template_widget_readmore_tab;
	$a3_responsive_slider_template_widget_readmore_tab->tab_manager();
}
