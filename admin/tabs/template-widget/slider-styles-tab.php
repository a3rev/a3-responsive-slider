...
<?php
/*-----------------------------------------------------------------------------------
Slider Widget Template Container Tab
...
class A3_Responsive_Slider_Template_Widget_Slider_Styles_Tab extends A3_Responsive_Slider_Admin_UI
{	
	/**
	 * @var string
	 */
	private $parent_page = 'a3-rslider-template-widget';
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'a3_responsive_slider_template_widget_slider_styles_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/template-widget/slider-styles-settings.php' );
...
$a3_responsive_slider_template_widget_slider_styles_tab = new A3_Responsive_Slider_Template_Widget_Slider_Styles_Tab();

/** 
 * people_contact_grid_view_tab_manager()
 * Define the callback function to show tab content
 */
function a3_responsive_slider_template_widget_slider_styles_tab_manager() {
	global $a3_responsive_slider_template_widget_slider_styles_tab;
	$a3_responsive_slider_template_widget_slider_styles_tab->tab_manager();
}
