...
class A3_Responsive_Slider_Template_Mobile_Pager_Tab extends A3_Responsive_Slider_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/template-mobile/pager-settings.php' );
...
$a3_responsive_slider_template_mobile_pager_tab = new A3_Responsive_Slider_Template_Mobile_Pager_Tab();
